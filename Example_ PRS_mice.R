...
ggplot(data = pca.predictor.df, aes(y = PC1, x = PC2, col = Litter == 1, fill = Litter == 1)) + geom_point(alpha = 0.5) + theme_clean()
ggplot(data = pca.predictor.df, aes(y = PC1, x = PC2, col = Litter == 2, fill = Litter == 2)) + geom_point(alpha = 0.5) + theme_clean()
ggplot(data = pca.predictor.df, aes(y = PC1, x = PC2, col = Litter == 3, fill = Litter == 3)) + geom_point(alpha = 0.5) + theme_clean()
ggplot(data = pca.predictor.df, aes(y = PC1, x = PC2, col = Litter == 4, fill = Litter == 4)) + geom_point(alpha = 0.5) + theme_clean()
ggplot(data = pca.predictor.df, aes(y = PC1, x = PC2, col = Litter == 5, fill = Litter == 5)) + geom_point(alpha = 0.5) + theme_clean()
ggplot(data = pca.predictor.df, aes(y = PC1, x = PC2, col = Litter == 6, fill = Litter == 6)) + geom_point(alpha = 0.5) + theme_clean()
ggplot(data = pca.predictor.df, aes(y = PC1, x = PC2, col = Litter == 7, fill = Litter == 7)) + geom_point(alpha = 0.5) + theme_clean()
ggplot(data = pca.predictor.df, aes(y = PC1, x = PC2, col = Litter == 8, fill = Litter == 8)) + geom_point(alpha = 0.5) + theme_clean()

# (yes I know this looks like it should be a loop, but you can't loop variables within ggplot without doing complicated stuff, so)
