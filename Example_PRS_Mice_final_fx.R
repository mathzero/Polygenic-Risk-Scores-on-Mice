...
is.na(mice.pheno)
sum(is.na(mice.pheno))
mean(is.na(mice.pheno))
...
save(model.EN.obesityBMI.Litter1, file=paste0(out.path,"model.EN.obesityBMI.Litter1.rds"))

pdf(paste0(out.path,"litter1on1LitterENplot.pdf")) 
...
save(MSELitter1EN, file=paste0(out.path,"MSElitter1EN.rds"))
...
# some plots
pdf(paste0 (out.path, "histbetaselectedENlitter1.pdf")) 
hist(b1$coefficient)
dev.off()

pdf(paste0 (out.path,"boxplotselectedvariableslitter1EN.pdf")) 
...
save(PRSscoresforlitter1EN, file= paste0(out.path, "ENPRSscoresforlitter1.rds"))
...
save(model.EN.obesityBMI.Litter2, file= paste0(out.path,"obesityonlyLitter2EN.rds"))

pdf(paste0(out.path, "litter2on2ENplot.pdf"))
...
save(MSELitter2EN, file=paste0(out.path,"~MSElitter2EN.rds"))
...
# some plots
pdf(paste0(out.path,"histbetaselectedlassolitter2on2EN.pdf"))
hist(b2$coefficient)
dev.off()

pdf(paste0(outpath,"boxplotselectedvariableslitter2EN.pdf"))
...
save(paste0(outpath,"PRSscoresforlitter2EN.rds"))
...
save(model.EN.obesityBMI.Litter3, file=paste0(out.path, "obesityLitter3EN.rds"))

pdf( paste0(out.path, "litter3ENplot.pdf"))
...
save(MSELitter3, file= paste0(out.path,"MSElitter3EN.rds"))
...
# some plots
pdf(paste0(out.path,"histbetaselectedENlitter3.pdf")) 
hist(b3$coefficient)
dev.off()

pdf(paste0(out.path,"boxplotselectedvariableslitter3EN.pdf")) 
...
save(PRSscoresforlitter3EN, file= paste0(out.path,"PRSscoresforlitter3EN.rds"))
...
save(model.EN.obesityBMI.Litter4, file=paste0(out.path, "obesityLitter4EN.rds"))

pdf(paste0(out.path,"litter4ENplot.pdf"))
...
save(MSELitter4, file= paste0(out.path,"MSElitter4EN.rds"))
...
# some plots
pdf(paste0(out.path,"histbetaselectedENlitter4.pdf")) 
hist(b4$coefficient)
dev.off()

pdf(paste0(out.path, "boxplotselectedvariableslitter4EN.pdf")) 
...
save(PRSscoresforlitter4EN, file=paste0(out.path,"PRSscoresforlitter4EN.rds"))
...
save(model.EN.obesityBMI.Litter5, file=paste0(out.path,"obesityLitter5EN.rds"))

pdf(paste0(outpath,"MSc_Project/litter5ENplot.pdf"))
...
save(MSELitter5, file= paste0(out.path,"Msc_Project/MSElitter5EN.rds"))
...
# some plots
pdf(paste0(out.path,"histbetaselectedENlitter5.pdf")) 
plot(b5$coefficient)
dev.off()

pdf(paste0(out.path,"boxplotselectedvariableslitter5EN.pdf"))
...
save(PRSscoresforlitter5EN, file=paste0(out.path,"PRSscoresforlitter5EN.rds"))
...
save(model.EN.obesityBMI.Litter6, file=paste0(out.path,"obesityLitter6lasso.rds"))

pdf(paste0(out.path,"litter6ENplot.pdf")) 
...
save(MSELitter6, file=paste0(out.path,"MSElitter6EN.rds"))
...
# some plots
pdf(paste0(out.path,"histbetaselectedENlitter6.pdf"))
hist(b6$coefficient)
dev.off()

pdf(paste0(out.path,"boxplotselectedvariableslitter6EN.pdf"))
...
save(PRSscoresforlitter6EN, file= paste0(out.path,"PRSscoresforlitter6EN.rds"))
...
save(model.EN.obesityBMI.Litter7, file= paste0 (out.path, "obesityLitter7EN.rds"))

pdf(paste0 (out.path, "litter7ENplot.pdf"))
...
save(MSELitter7, file= paste0(out.path,"MSElitter7EN.rds"))
...
# some plots
pdf(paste0(out.path,"ENlitter7.pdf")) 
hist(b7$coefficient)
dev.off()

pdf(paste0(out.path,"boxplotselectedvariableslitter7EN.pdf")) 
...
save(PRSscoresforlitter7EN, file= paste0(out.path,"PRSscoresforlitter7EN.rds"))
...
save(model.EN.obesityBMI.Litter8, file= paste0(out.path,"obesityLitter8EN.rds"))

pdf(paste0(out.path, "litter8ENplot.pdf")) 
...
save(MSELitter8, file= paste0(out.path,"MSElitter8EN.rds"))
...
# some plots
pdf(paste0(out.path,"histbetaselectedENlitter8.pdf")) 
hist(b8$coefficient)
dev.off()

pdf(paste0(out.path,"boxplotselectedvariableslitter8EN.pdf")) 
...
save(PRSscoresforlitter8EN, file= paste0(out.path,"PRSscoresforlitter8EN.rds"))
hist(PRSscoresforlitter8EN)


#More efficient code: loop through litters (1:4)


# Loop to create PRS for each litter -----------------------------------------------------
...
save(model.EN.obesityBMI.Litterx, file= paste0(out.path,"obesityonlyalllitersxEN.rds"))
...
save(MSELitterx, file=paste0(out.path, "MSElitterxEN.rds"))
...
save(PRSscoresforalllittersEN, file=paste0(out.path,"PRSscoresforalllittersEN.rds"))
...
# Writing tables and Running T t-tests ----------------------------------------------------------

write.table(PRSscoresforalllittersEN, paste0(out.path,"Scoreforallls.txt"), sep="\t" )
write.table(PRSscoresforlitter1EN, paste0(out.path, "Score21sEN.txt"), sep="\t")
write.table(PRSscoresforlitter2EN, paste0(out.path, "Score2lsEN.txt"), sep="\t")
write.table(PRSscoresforlitter3EN, paste0(out.path, "Score3lsEN.txt"), sep="\t")
write.table(PRSscoresforlitter4EN, paste0(out.path, "Score4lsEN.txt"), sep="\t")

#Example of T-test

df1<-read.csv("/Users/shatirahman/Documents/Msc_Project/T_test_EN.csv") #had everything saved a CSV (please insert your pathway)
head(df1)


t.test(df1$L2, df1$L1, paired = TRUE, var.equal=TRUE)
t.test(df1$L2, df$L3, paired= TRUE, var.equal=TRUE)
...
pdf(paste0(out.path, "heatmapEN.pdf"))
...
write.table(RMSE.matrix, paste0(out.path,"RMSEmatrix1_8.txt"), sep="\t")
