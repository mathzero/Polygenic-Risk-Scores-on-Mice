...
out.path<-"~/Users/shatirahman/MSc_Project" #insert your file pathway here
...
save(model.EN.obesityBMI.Litter1, file=paste0(out.path,"/model.EN.obesityBMI.Litter1"))
...
save(MSELitter1EN, file=paste0(out.path,"MSElitter1EN.RData"))
...
save(PRSscoresforlitter1EN, file= paste0(out.path, "ENPRSscoresforlitter1.RData"))
...
save(model.EN.obesityBMI.Litter2, file= paste0(out.path,"obesityonlyLitter2EN.RData"))
...
save(MSELitter2EN, file=paste0(out.path,"~MSElitter2EN.RData"))
...
save(paste0(outpath,"PRSscoresforlitter2EN.RData"))
...
save(model.EN.obesityBMI.Litter3, file=paste0(out.path, "obesityLitter3EN.RData"))
...
save(MSELitter3, file= paste0(out.path,"MSElitter3EN.RData"))
...
save(PRSscoresforlitter3EN, file= paste0(out.path,"PRSscoresforlitter3EN.RData"))
...
save(model.EN.obesityBMI.Litter4, file=paste0(out.path, "obesityLitter4EN.RData"))
...
save(MSELitter4, file= paste0(out.path,"MSElitter4EN.RData"))
...
save(PRSscoresforlitter4EN, file=paste0(out.path,"PRSscoresforlitter4EN.RData"))
...
save(model.EN.obesityBMI.Litter5, file=paste0(out.path,"obesityLitter5EN.RData"))
...
save(MSELitter5, file= paste0(out.path,"Msc_Project/MSElitter5EN.RData"))
...
save(PRSscoresforlitter5EN, file=paste0(out.path,"PRSscoresforlitter5EN.RData"))
...
save(model.EN.obesityBMI.Litter6, file=paste0(out.path,"obesityLitter6lasso.RData"))
...
save(MSELitter6, file=paste0(out.path,"MSElitter6EN.RData"))
...
save(PRSscoresforlitter6EN, file= paste0(out.path,"PRSscoresforlitter6EN.RData"))
...
save(model.EN.obesityBMI.Litter7, file= paste0 (out.path, "obesityLitter7EN.RData"))
...
save(MSELitter7, file= paste0(out.path,"MSElitter7EN.RData"))
...
save(PRSscoresforlitter7EN, file= paste0(out.path,"PRSscoresforlitter7EN.RData"))
...
save(model.EN.obesityBMI.Litter8, file= paste0(out.path,"obesityLitter8EN.RData"))
...
save(MSELitter8, file= paste0(out.path,"MSElitter8EN.RData"))
...
save(PRSscoresforlitter8EN, file= paste0(out.path,"PRSscoresforlitter8EN.RData"))
